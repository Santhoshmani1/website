...
const Skills = () => {
  return (
    ...
    >
      ...
      <h3 className="p-4 m-2 text-2xl font-bold text-center dark:text-blue-400">
      ...
      <div className="flex flex-wrap items-center p-2 m-auto languages-container justify-evenly lg:w-1/2">
        {programmingLanguages.map((language, index) => (
          <div
            key={index}
            className="flex flex-col items-center justify-center skill"
          >
            <span
      ...
      <div className="flex flex-wrap items-center justify-center p-2 web-technologies-container">
        {webTechnologies.map((technology, index) => (
          <div
            key={index}
            className="flex flex-col items-center justify-center px-4 py-2 text-xl skill"
          >
            <div
              className="m-auto text-6xl text-center techhnology-icon"
